...
export default function Home() {
  ...
  return (
    <PageShell noTopPadding={true}>
      ...
      <section className="py-12 sm:py-20 relative overflow-hidden bg-[#090B0E] border-t border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <h2 className="text-xl sm:text-3xl lg:text-4xl font-extrabold font-heading text-white tracking-tight leading-tight mb-4 sm:mb-5">
                Strategic UAE Advisory from the Heart of Dubai Silicon Oasis
              </h2>
              <p className="text-xs sm:text-base text-slate-300 leading-relaxed font-normal mb-4 sm:mb-6">
              ...
              <p className="text-xs sm:text-base text-slate-300 leading-relaxed font-normal mb-6 sm:mb-8 hidden sm:block">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3 mb-6 sm:mb-8">
                {[
                  ...
                  <div key={i} className="flex items-center gap-2 text-xs sm:text-sm font-medium">
                    <CheckCircle2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#C8A55E] shrink-0" />
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 px-5 py-2.5 sm:px-6 sm:py-3 rounded-lg bg-[#12151B] hover:bg-[#1A1F29] border border-[#C8A55E]/40 hover:border-[#C8A55E] text-[#EFE4CA] font-semibold text-xs sm:text-sm transition-all"
              >
                <span>Read Full Corporate Profile & Licensing</span>
                <ArrowRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#C8A55E]" />
              </Link>
            </div>

            {/* Right Column: Institutional Verification Card */}
            <div className="lg:col-span-5">
              <div className="furcak-card p-5 sm:p-7 lg:p-8 rounded-2xl relative shadow-xl">
                <div className="flex items-center gap-3 mb-4 sm:mb-6 pb-3 sm:pb-4 border-b border-slate-800/80">
                ...
                <div className="space-y-3 sm:space-y-4 text-xs sm:text-sm text-slate-300">
                  <div className="flex items-start gap-2">
                    <ShieldCheck className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#C8A55E] shrink-0 mt-0.5" />
                    <span>
                ...
                <div className="mt-4 sm:mt-6 pt-3 sm:pt-5 border-t border-slate-800/80 flex items-center justify-between text-xs">
      ...
      <section className="py-12 sm:py-20 relative overflow-hidden bg-[#07090C] border-t border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 sm:mb-14 gap-4 sm:gap-6">
            <div className="max-w-2xl">
              ...
              <h2 className="text-xl sm:text-3xl lg:text-4xl font-extrabold font-heading text-white tracking-tight leading-tight">
                Six Pillars of Advisory Excellence
              </h2>
              <p className="mt-2 text-xs sm:text-base text-slate-300 font-normal">
            ...
            <Link
              href="/services"
              className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold text-[#EFE4CA] hover:text-white transition-colors shrink-0"
            >
          ...
          {/* Service Grid Overview (Responsive: 1 col on mobile, 2 on md, 3 on lg) */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {SERVICES_DATA.slice(0, 6).map((service) => {
              const getServiceIcon = (name: string) => {
                switch (name) {
                  case "TrendingUp":
                    return <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-[#C8A55E]" />;
                  case "Target":
                    return <Target className="w-4 h-4 sm:w-5 sm:h-5 text-[#C8A55E]" />;
                  case "Building2":
                    return <Building2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#C8A55E]" />;
                  case "Globe2":
                    return <Globe2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#C8A55E]" />;
                  case "Handshake":
                    return <Handshake className="w-4 h-4 sm:w-5 sm:h-5 text-[#C8A55E]" />;
                  default:
                    return <Briefcase className="w-4 h-4 sm:w-5 sm:h-5 text-[#C8A55E]" />;
                }
              };
              ...
              return (
                <Link
                  key={service.id}
                  href="/services"
                  className="group furcak-card rounded-xl p-4 sm:p-6 flex flex-col justify-between hover:border-[#C8A55E]/50 transition-all block"
                >
                  <div>
                    <div className="flex items-center justify-between mb-3 sm:mb-4 pb-2.5 sm:pb-3 border-b border-slate-800/80">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-[#181C24] border border-[#C8A55E]/30 flex items-center justify-center group-hover:border-[#C8A55E] transition-colors">
                    ...
                    <h3 className="text-sm sm:text-base lg:text-lg font-bold font-heading text-white group-hover:text-[#EFE4CA] transition-colors mb-2">
                      {service.title}
                    </h3>
                    <p className="text-xs sm:text-sm text-slate-300 leading-relaxed font-normal mb-3 sm:mb-5 line-clamp-2">
                      {service.shortDesc}
                    </p>
                  </div>

                  <div className="pt-2.5 sm:pt-3 border-t border-slate-800/80 flex items-center justify-between text-[11px] sm:text-xs font-semibold text-slate-400 group-hover:text-[#EFE4CA] transition-colors">
          ...
          <div className="mt-8 sm:mt-10 text-center">
            <Link
              href="/services"
              className="inline-flex items-center gap-2 px-6 py-3 sm:px-7 sm:py-3.5 rounded-lg gold-gradient-bg text-[#090B0E] font-bold text-xs sm:text-sm shadow-md hover:brightness-105 transition-all"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 sm:gap-4">
            {INDUSTRIES_DATA.map((ind) => (
              <Link
                key={ind.id}
                href="/industries"
                className="group p-3 sm:p-5 rounded-xl bg-[#12151B] border border-slate-800 hover:border-[#C8A55E]/40 transition-all flex flex-col justify-between"
              >
                <div>
                ...
                <div className="mt-3 pt-2 sm:pt-3 border-t border-slate-800/80 flex items-center justify-between text-[10px] sm:text-[11px] text-slate-400 group-hover:text-[#EFE4CA]">
                  <span>Explore</span>
                  <ArrowRight className="w-3 h-3 text-[#C8A55E]" />
                </div>
              </Link>
      ...
      <section className="py-12 sm:py-20 relative overflow-hidden bg-[#07090C] border-t border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3 sm:gap-4 mb-8 sm:mb-10">
            {APPROACH_STEPS.map((step) => (
              <div
                key={step.step}
                className="furcak-card p-4 sm:p-5 rounded-xl flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-2 sm:mb-3">
                    <span className="font-mono text-[11px] sm:text-xs font-bold text-[#C8A55E]">
                      PHASE {step.step}
                    </span>
                  </div>
                  ...
                  <p className="text-[11px] sm:text-xs text-[#EFE4CA] font-medium mb-2">
                    {step.tagline}
                  </p>
                  <p className="text-xs text-slate-300 leading-relaxed font-normal line-clamp-2 sm:line-clamp-3">
                    {step.description}
                  </p>
                </div>
              </div>
      ...
      <section className="py-12 sm:py-20 relative overflow-hidden bg-[#090B0E] border-t border-slate-800/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="furcak-card rounded-2xl p-6 sm:p-10 lg:p-12 relative shadow-2xl">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
              <div className="lg:col-span-4 flex flex-col items-center text-center">
                ...
                <div className="mt-2.5 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#181C24] border border-[#C8A55E]/30 text-[10px] sm:text-[11px] text-slate-300 font-medium">
              ...
              <div className="lg:col-span-8">
                ...
                <h4 className="text-base sm:text-xl lg:text-2xl font-bold font-heading text-white mb-3 sm:mb-4">
                ...
                <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                  <Link
                    href="/leadership"
                    className="inline-flex items-center gap-2 px-5 py-2.5 sm:px-6 sm:py-3 rounded-lg gold-gradient-bg text-[#090B0E] font-bold text-xs sm:text-sm shadow-md hover:brightness-105 transition-all"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2.5 sm:px-5 sm:py-3 rounded-lg bg-[#12151B] hover:bg-[#1A1F29] border border-[#C8A55E]/40 text-[#EFE4CA] font-semibold text-xs sm:text-sm transition-all cursor-pointer"
                  >
                    <Calendar className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#C8A55E]" />
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-r from-[#12151B] via-[#161B24] to-[#12151B] border-t border-[#C8A55E]/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 shrink-0 w-full sm:w-auto">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 sm:px-7 sm:py-3.5 rounded-lg gold-gradient-bg text-[#090B0E] font-bold text-xs sm:text-sm shadow-md hover:brightness-105 transition-all text-center"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-3 sm:px-6 sm:py-3.5 rounded-lg bg-emerald-950/30 hover:bg-emerald-900/40 text-emerald-300 border border-emerald-500/40 font-semibold text-xs sm:text-sm transition-all text-center"
            >
